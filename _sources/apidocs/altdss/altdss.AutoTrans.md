...
:canonical: altdss.AutoTrans.AutoTrans.pctEmerg

```{autodoc2-docstring} altdss.AutoTrans.AutoTrans.pctEmerg
```
...
:canonical: altdss.AutoTrans.AutoTrans.pctNorm

```{autodoc2-docstring} altdss.AutoTrans.AutoTrans.pctNorm
```
