...
class Load(DSSObj, CircuitElementMixin, PCElementMixin):
    ...
    def edit(self, **kwargs: Unpack[LoadProperties]) -> Load:
        """
        Edit this Load.
...
class LoadBatch(DSSBatch, CircuitElementBatchMixin, PCElementBatchMixin):
    ...
    def edit(self, **kwargs: Unpack[LoadBatchProperties]) -> LoadBatch:
        """
...
class ILoad(IDSSObj, LoadBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> LoadBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
            Creates a new batch handler of (existing) Load objects
            """
            return self._batch_cls(self._api_util, **kwargs)

        def __iter__(self) -> Iterator[Load]:
            yield from LoadBatch.__iter__(self)

        
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[LoadProperties]) -> Load:
        """
        Creates a new Load.
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[LoadBatchProperties]) -> LoadBatch:
        """
