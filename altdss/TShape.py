...
class TShape(DSSObj):
    ...
    def edit(self, **kwargs: Unpack[TShapeProperties]) -> TShape:
        """
        Edit this TShape.
...
class TShapeBatch(DSSBatch):
    ...
    def edit(self, **kwargs: Unpack[TShapeBatchProperties]) -> TShapeBatch:
        """
        Edit this TShape batch.
...
class ITShape(IDSSObj, TShapeBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> TShapeBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
    ...
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[TShapeProperties]) -> TShape:
        """
        Creates a new TShape.
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[TShapeBatchProperties]) -> TShapeBatch:
        """
        Creates a new batch of TShape objects
