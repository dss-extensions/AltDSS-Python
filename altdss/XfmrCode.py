...
class IXfmrCode(IDSSObj, XfmrCodeBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> XfmrCodeBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
            Creates a new batch handler of (existing) XfmrCode objects
            """
            return self._batch_cls(self._api_util, **kwargs)

        def __iter__(self) -> Iterator[XfmrCode]:
            yield from XfmrCodeBatch.__iter__(self)

        
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[XfmrCodeProperties]) -> XfmrCode:
        """
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[XfmrCodeBatchProperties]) -> XfmrCodeBatch:
        """
