...
class IStorageController(IDSSObj, StorageControllerBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> StorageControllerBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
            Creates a new batch handler of (existing) StorageController objects
            """
            return self._batch_cls(self._api_util, **kwargs)

        def __iter__(self) -> Iterator[StorageController]:
            yield from StorageControllerBatch.__iter__(self)

        
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[StorageControllerProperties]) -> StorageController:
        """
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[StorageControllerBatchProperties]) -> StorageControllerBatch:
        """
