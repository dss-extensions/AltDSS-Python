...
class Relay(DSSObj, CircuitElementMixin):
    ...
    def edit(self, **kwargs: Unpack[RelayProperties]) -> Relay:
        """
        Edit this Relay.
...
class RelayBatch(DSSBatch, CircuitElementBatchMixin):
    ...
    def edit(self, **kwargs: Unpack[RelayBatchProperties]) -> RelayBatch:
        """
...
class IRelay(IDSSObj, RelayBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> RelayBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
            Creates a new batch handler of (existing) Relay objects
            """
            return self._batch_cls(self._api_util, **kwargs)

        def __iter__(self) -> Iterator[Relay]:
            yield from RelayBatch.__iter__(self)

        
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[RelayProperties]) -> Relay:
        """
        Creates a new Relay.
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[RelayBatchProperties]) -> RelayBatch:
        """
