...
class InvControlBatch(DSSBatch, CircuitElementBatchMixin):
    ...
    def edit(self, **kwargs: Unpack[InvControlBatchProperties]) -> InvControlBatch:
        """
...
class IInvControl(IDSSObj, InvControlBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> InvControlBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
    ...
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[InvControlProperties]) -> InvControl:
        """
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[InvControlBatchProperties]) -> InvControlBatch:
        """
