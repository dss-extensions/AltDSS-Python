...
class StorageBatch(DSSBatch, CircuitElementBatchMixin, PCElementBatchMixin):
    ...
    def edit(self, **kwargs: Unpack[StorageBatchProperties]) -> StorageBatch:
        """
...
class IStorage(IDSSObj, StorageBatch):
    ...
    if TYPE_CHECKING:
        ...
        def batch(self, **kwargs) -> StorageBatch: #TODO: add annotation to kwargs (specialized typed dict)
            """
    ...
    def new(self, name: AnyStr, *, begin_edit: Optional[bool] = None, activate=False, **kwargs: Unpack[StorageProperties]) -> Storage:
        """
    ...
    def batch_new(self, names: Optional[List[AnyStr]] = None, *, df = None, count: Optional[int] = None, begin_edit: Optional[bool] = None, **kwargs: Unpack[StorageBatchProperties]) -> StorageBatch:
        """
